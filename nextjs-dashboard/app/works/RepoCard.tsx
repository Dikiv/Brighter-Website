...
export default function UserCard({ repo }: RepoProps) {
  ...
  return (
    ...
    <div className='flex-initial sm:flex-row bg-blue-900 bg-gradient-to-b from-gray-800 border-yellow-700 hover:border-yellow-500 to-black border-2 mt-6 p-3'>
